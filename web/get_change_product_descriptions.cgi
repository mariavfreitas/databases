...
print('</head>')
print('<body>')
print('<h2>Change Product Description</h2>')

print('<h3>Choose a Product to change its description:</h3>')
connection = None
try:
    ...
    for row in result:
        ...
        print('<td><a href="set_change_product_descriptions.cgi?SKU={}" class="button">Change</a></td>'.format(row[0]))
        print('</tr>')
    print('</table>')
