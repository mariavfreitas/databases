...
print('</head>')
print('<body>')
print('<h2>Remove Customer</h2>')
print('<h3>Choose a Customer to be removed:</h3>')
...
try:
    ...
    for row in result:
        ...
        print('<td><a href="set_remove_customers.cgi?cust_no={}" class="button">X</a></td>'.format(row[0]))
        print('</tr>')
    print('</table>')
